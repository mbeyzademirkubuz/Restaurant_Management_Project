                ...
                try
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(selectData, connect))
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            md.ID = (int)reader["food_id"];
                            md.İSİM = reader["food_name"].ToString();
                            md.TÜR = reader["food_type"].ToString();
                            md.FİYAT = (int)reader["food_price"];
                            md.İÇERİK = reader["food_description"].ToString();
                            md.FOTOĞRAF = reader["food_image"].ToString();
