...
namespace Restaurant_Management_Project
{
    public partial class formDashboard : Form
    {
        ...
        private void buttonDashboard_Click(object sender, EventArgs e)
        {
            ...
            panelNav.Left = buttonDashboard.Left;
            buttonDashboard.BackColor = Color.FromArgb(49, 48, 77);
            //buttonDashboard.BackColor = Color.FromArgb(182, 187, 196);*/
        ...
        private void buttonStatistic_Click(object sender, EventArgs e)
        {
            ...
            /*panelNav.Height = buttonStatistic.Height;
             panelNav.Top = buttonStatistic.Top;
             buttonStatistic.BackColor = Color.FromArgb(49, 48, 77);*/
        }
